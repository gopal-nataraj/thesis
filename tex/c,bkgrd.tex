...
that additionally impart non-constant
(often quadratically increasing)
transverse magnetization phase
\cite{zur:91:sot}.
Though the non-constant RF phase
...
\begin{align}
	...
	\bmE\paren{\bmr,\TR;\frac{\TP}{2}+\TE} \bmS \bmmp\paren{\bmr,\frac{\TP}{2}+\TE} \nonumber \\
...
centered at position $\bmr$ is
\begin{align}
	\spgr\pr 
	&:= \int_{\setv\pr} \mxyp\paren{\bmr,t_0+\frac{\TP}{2}+\TE} \dercubed{\bmr} 
		\label{eq:spgr-int} \\
