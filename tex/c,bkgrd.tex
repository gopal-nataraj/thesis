...
written as
\begin{align}
	\est{\bmx} \in \set{\argmin{\setx} \costa{\bmx}}.
	\label{eq:opt-gen}
\end{align}
...
Thus,
most QMRI problems
in the form of \eqref{eq:opt-gen}
are non-convex optimization problems.

In general, 
solving \eqref{eq:opt-gen}
...
% local vs global
% initialization, attraction basin
