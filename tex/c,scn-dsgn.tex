...
\footnote{%
	...
	from published journal paper \cite{nataraj:17:oms}
	that extends conference paper \cite{nataraj:15:amm}.
}
describes a systematic method 
...
by recording close to twice as much data per scan. 
...
Section~\ref{s,scn-dsgn,multi} investigates
the sensitivity of single-compartment $\Tt$ estimates
to model mismatch due to multi-compartment relaxation.
Section~\ref{s,scn-dsgn,disc} discusses 
advantages, challenges, and extensions.
...
within the orifice of the main magnet.
...
correspond to WM and GM regions of interest (ROIs)
	...
	\fbox{ 
		\begin {minipage} [b] [12.5cm] [b] {0.54\textwidth}
			\subfigure [$\sigwot$ vs. $(\alpha_1^\mathrm{spgr}, \alpha_2^\mathrm{spgr})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t1_vs_s1s2_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t1,s1s2,21}
			}
			\subfigure [$\sigwot$ vs. $(\alpha_1^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t1_vs_s1d1_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t1,s1d1,21}
			}
			\subfigure [$\sigwot$ vs. $(\alpha_2^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t1_vs_s2d1_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t1,s2d1,21}
			}
			
			\subfigure [$\sigwtt$ vs. $(\alpha_1^\mathrm{spgr}, \alpha_2^\mathrm{spgr})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t2_vs_s1s2_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t2,s1s2,21}
			}
			\subfigure [$\sigwtt$ vs. $(\alpha_1^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t2_vs_s1d1_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t2,s1d1,21}
			}
			\subfigure [$\sigwtt$ vs. $(\alpha_2^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t2_vs_s2d1_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t2,s2d1,21}
			}
			
			\subfigure [$\costwt$ vs. $(\alpha_1^\mathrm{spgr}, \alpha_2^\mathrm{spgr})$] {
				\includegraphics [height=3.41cm] {dsgn/Psiw_vs_s1s2_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t1,s1s2,21}
			}
			\subfigure [$\costwt$ vs. $(\alpha_1^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/Psiw_vs_s1d1_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t1,s1d1,21}
			}
			\subfigure [$\costwt$ vs. $(\alpha_2^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/Psiw_vs_s2d1_21_41p90ms_0p1_1.eps}
				\label{fig:sigw,t1,s2d1,21}
			}
		\end{minipage}
	}
	\fbox{ 
		\begin {minipage} [b] [12.5cm] [b] {0.18\textwidth}
			\subfigure [$\sigwot$ vs. $(\alpha^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t1_vs_s1d1_11_41p90ms_0p1_1.eps}
				\label{fig:sigw,t1,s1d1,11}
			}
			
			\subfigure [$\sigwtt$ vs. $(\alpha^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t2_vs_s1d1_11_41p90ms_0p1_1.eps}
				\label{fig:sigw,t2,s1d1,11}
			}
			
			\subfigure [$\costwt$ vs. $(\alpha^\mathrm{spgr}, \alpha^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/Psiw_vs_s1d1_11_41p90ms_0p1_1.eps}
	...
	\fbox{ 
		\begin {minipage} [b] [12.5cm] [b] {0.18\textwidth}
			\subfigure [$\sigwot$ vs. $(\alpha_1^\mathrm{dess}, \alpha_2^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t1_vs_d1d2_02_41p90ms_0p1_1.eps}
				\label{fig:sigw,t1,d1d2,02}
			}
			
			\subfigure [$\sigwtt$ vs. $(\alpha_1^\mathrm{dess}, \alpha_2^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/sigw_t2_vs_d1d2_02_41p90ms_0p1_1.eps}
				\label{fig:sigw,t2,d1d2,02}
			}
			
			\subfigure [$\costwt$ vs. $(\alpha_1^\mathrm{dess}, \alpha_2^\mathrm{dess})$] {
				\includegraphics [height=3.41cm] {dsgn/Psiw_vs_d1d2_02_41p90ms_0p1_1.eps}
				\label{fig:Psiw,d1d2,02}
			}
		\end{minipage}	
	}
	\caption{
		Worst-case standard deviations 
		$\sigwot$ (top), $\sigwtt$ (middle), 
		and cost $\costwt$ (bottom), 
		versus pairs of nominal flip angles, 
		holding other scan parameters fixed at selected profile $\bmPs$. 
		Subfigures (a)-(i), (j)-(l), and (m)-(o) 
		correspond to scan profiles containing 
		$(\Ss, \Sd) = (2,1), (1,1), 
		\text{and}\,(0,2)$ SPGR and DESS scans, 
		respectively. 
		Selected scan parameters (starred) 
		are within $\delta = 1$\% of global minimizers 
		and retain as much estimator precision as possible 
		over a wide range of latent object parameters. 		
		All axes range from 5 to 90 degrees, in 5-degree increments. 
		Colorbar ranges are $[0,100]$, $[0,10]$, and $[0,20]$ milliseconds
		for rows of $\sigwot$, $\sigwtt$, and $\costwt$ subfigures,
		respectively. 
		The optimized $(0,2)$ profile 
		appears most robust to transmit field spatial variation.
	}
...
\begin{figure} [!tbp]
	...
	\subfigure [$\ToML$ in voxels with WM-like $\To \gets 832$] {
		\includegraphics [width = 0.43\textwidth] {%
			sim/T1_hist_ml_wm_3parm_0SPGR2DESS.eps%
		}
	...
	\subfigure [$\ToML$ in voxels with GM-like $\To \gets 1331$] {
		\includegraphics [width = 0.43\textwidth] {%
			sim/T1_hist_ml_gm_3parm_0SPGR2DESS.eps%
		}
	...
	\subfigure [$\TtML$ in voxels with WM-like $\Tt \gets 79.6$] {
		\includegraphics [width = 0.43\textwidth] {%
			sim/T2_hist_ml_wm_3parm_0SPGR2DESS.eps%
		}
	...
	\subfigure [$\TtML$ in voxels with GM-like $\Tt \gets 110$] {
		\includegraphics [width = 0.43\textwidth] {%
			sim/T2_hist_ml_gm_3parm_0SPGR2DESS.eps%
		}
...
The subfigures of Fig.~\ref{fig:scn-dsgn,normal} superimpose 
...
\footnote{%
	...
	by instead jointly estimating 
	$\bmMz$, $\bmTo$, $\bmTt$, and 	inversion efficiency 
...
\begin{figure*} [!tb]
	\centering
	\subfigure{
		\includegraphics [width=15.4cm] {hpd/2016-06-20,hpd,t1,jet.eps}
		\label{fig:hpd,t1,jet}
	}
	\vspace{0cm}
	\subfigure{
		\includegraphics [width=15.2cm, trim=0 0 0 25, clip] {hpd/2016-06-20,hpd,t2,jet.eps}
...
\begin{figure*} [!tb]
	\centering
	\subfigure{
		\includegraphics [width=15.4cm] {hpd/2016-06-20,hpd,t1,gray.eps}
		\label{fig:hpd,t1,gray}
	}
	\vspace{0cm}
	\subfigure{
		\includegraphics [width=15.2cm, trim=0 0 0 25, clip] {hpd/2016-06-20,hpd,t2,gray.eps}
...
\begin{figure*} [!tbp]
	...
	\subfigure [$\ToML$ Estimates] {%
		\includegraphics [width = 0.45\textwidth] {hpd/2016-06-20,hpd,t1-ml-compare.eps}
		\label{fig:t1,hpd,ml}
	}
	\hspace{0.3cm}
	\subfigure [$\TtML$ Estimates] {%
		\includegraphics [width = 0.45\textwidth] {hpd/2016-06-20,hpd,t2-ml-compare.eps}
		\label{fig:t2,hpd,ml}
	}
	\vspace{-0.3cm}
	\subfigure [$\ToRL$ Estimates] {%
		\includegraphics [width = 0.45\textwidth] {hpd/2016-06-20,hpd,t1-rls-compare.eps}
		\label{fig:t1,hpd,rls}
	}
	\hspace{0.3cm}
	\subfigure [$\TtRL$ Estimates] {%
		\includegraphics [width = 0.45\textwidth] {hpd/2016-06-20,hpd,t2-rls-compare.eps}
	...
	\caption{%
		...
		in Fig.~\ref{fig:scn-dsgn,hpd,gray}.
...
Table~\ref{tab:scn-dsgn,hpd,std-dev} reports 
...
\begin{figure*} [!tbp]
	...
	\subfigure{%
		\includegraphics [width=15.4cm] {%
			brain/2016-05-31,brain,t1,jet.eps%
		}%
	...
	\subfigure{%
		\includegraphics [width=15.2cm, trim=0 0 0 25, clip] {%
			brain/2016-05-31,brain,t2,jet.eps%
		}%
...
\begin{table*} [tb]
	...
	\begin{minipage}{0.18\textwidth}
		\includegraphics [width=2.8cm] {brain/2016-05-31,brain,roi,gray.eps}
		\label{fig:scn-dsgn,brain,roi,gray}
	\end{minipage}
...
within-ROI sample means and sample standard deviations compute
\footnote{%
	We have taken effort 
...
Section~\ref{s,scn-dsgn,multi} 
studies $\bmTt$ estimation bias
due to multi-compartmental relaxation
in more detail.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Sensitivity to Multiple-Compartment Relaxation}
\label{s,scn-dsgn,multi}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

This section investigates 
through simulations and \invivo experiments
the sensitivity of single-compartment $\bmTt$ estimates 
to model mismatch
due to multi-compartment relaxation.
The exploratory study 
in SE data discussed here
inspired other similar unreported studies 
in SPGR/DESS data
that contributed 
to the development of Ch.~\ref{c,mwf}.

We simulate multi-exponential data 
to arise from three non-exchanging pools 
of myelinated water 
$(T_1,T_2) \leftarrow (500,20)$ms, 
intracellular and extracellular water 
$(T_1,T_2) \leftarrow (1000,80)$ms, 
and free water 
$(T_1,T_2) \leftarrow (3500,250)$ms 
\cite{mackay:94:ivv, deoni:13:oct}. 
We assign pool fractions of $(0.15, 0.80, 0.05)$ in WM 
and $(0, 0.95, 0.05)$ in GM 
to the 81st slice 
of the BrainWeb digital phantom 
\cite{kwan:99:msb, collins:98:dac} 
to create ground truth 
$\mathbf{M}_0$, $\mathbf{T}_1$, and $\mathbf{T}_2$ 
compartment-wise maps.
We simulate component-wise IR signals 
(acquisition parameters 
in Subsection~\ref{sss,scn-dsgn,exp,phant,roi}) 
and add them to yield noiseless multi-component IR data. 
We likewise simulate and then add component-wise SE signals 
to construct three scan profiles 
consisting of pairs of multi-component SE datasets 
with variable 
$\mathbf{T}_\mathrm{E} \in \set{[10,30]^\mathsf{T}, 
	[10,60]^\mathsf{T}, [10,150]^\mathsf{T}}$.
To avoid confounding sources of bias, 
we assume knowledge of a uniform transmit field 
and a uniform sensitivity profile 
of a single-channel receive coil.
We estimate a single-component $\widehat{\mathbf{T}}_1$ ML map 
from multi-component IR data, 
which we then use 
to estimate a single-component $\widehat{\mathbf{T}}_2$ ML map 
from each multi-exponential SE scan profile.
	
\begin{figure*} [!tb]
	\centering
	\subfigure{%
		\includegraphics [width=\textwidth, clip] {%
			multi-t2/2016-07-17,syn,multi-t2,jet.eps%
		}%
		\label{fig:scn-dsgn,syn,multi-t2,jet}
	}
	\vspace{0cm}
	\subfigure{%
		\includegraphics [width=\textwidth, trim=0 0 0 10, clip] {%
			multi-t2/2016-05-31,brain,multi-t2,jet.eps%
		}%
		\label{fig:scn-dsgn,brain,multi-t2,jet}
	}%
	\caption{%
		Colorized monoexponential $\mathbf{T}_2$ ML estimates 
		from pairs of (top) multi-exponential simulated 
		and (bottom) \emph{in vivo} SE datasets. 
		Columns denote SE dataset echo times. 
		Colorbar ranges are in milliseconds.
	}%
	\label{fig:scn-dsgn,multi-t2,jet}
\end{figure*}

The upper row of Fig.~\ref{fig:scn-dsgn,multi-t2,jet} 
compares $\widehat{\mathbf{T}}_2$ maps 
from simulated multi-exponential SE data.
The lower row of Fig.~\ref{fig:scn-dsgn,multi-t2,jet} 
compares \emph{in vivo} $\widehat{\mathbf{T}}_2$ maps 
from corresponding subsets 
of the SE reference profile 
discussed in Section~\ref{ss,scn-dsgn,exp,invivo}.
As echo times are further separated, 
$\widehat{T}_2$ in WM 
approaches $\widehat{T}_2$ in GM, 
creating an apparent reduction 
in $\widehat{T}_2$ WM/GM contrast.

\begin{table*} [t]
	\centering
	\begin{tabu} {c | c | r r r}
		\hline 
		\hline
			& ROI  		& $(10,30)$ 		& $(10,60)$			& $(10,150)$ \\
		\hline
		\multirow{5}{*}{$\TtML$}
			& \AR WM  & $54 \pm 3.0$ 	& $ 56 \pm 1.9$	& $54 \pm 2.4$ \\
			& \AL WM 	& $50. \pm 2.2$	& $ 54 \pm 1.8$	& $54 \pm 2.4$ \\
			& \PR WM  & $55 \pm 2.6$ 	& $58 \pm 2.2$	& $61 \pm 2.6$ \\
			& \PL WM  & $50 \pm 2.2$ 	& $57 \pm 2.0$	& $61 \pm 2.1$ \\
			& \A  GM  & $58 \pm 6.5$ 	& $61 \pm 6.8$ 	& $57 \pm 7.3$ \\
		\hline 
		\hline
	\end{tabu}
	\caption{%
		Within-ROI sample means $\pm$ 
		within-ROI sample standard deviations 
		of monoexponential $\mathbf{T}_2$ ML estimates, 
		from pairs of \emph{in vivo} SE datasets.
		Column headers indicate echo times $\mathbf{T}_\mathrm{E}$ (ms) 
		of SE datasets.
		Sample statistics are computed 
		within ROIs indicated in Table~\ref{tab:scn-dsgn,brain}.
		Single-component $\TtML$ estimates 
		in WM depend on SE echo times.
	}%
	\label{tab:scn-dsgn,multi-t2}
\end{table*}

Table~\ref{tab:scn-dsgn,multi-t2} summarizes 
$\TtML$ sample means and sample standard deviations 
(computed within WM/GM ROIs 
depicted in Table~\ref{tab:scn-dsgn,brain}) 
from \emph{in vivo} SE scan profiles.
Single-component $\TtML$ estimates 
depend on SE echo times 
more significantly in WM than in GM.
Comparing with Table~\ref{tab:scn-dsgn,brain}, 
trends suggest that disagreement 
in $\TtML$ estimates across scan profiles 
may in part be attributable 
to the substantial differences 
of acquisition parameters (\eg, echo times) 
used in different pulse sequences. 
...
multiple intravoxel water compartments).
However, it is apparent 
that the nonlinear estimation procedures required 
for many mapping problems 
can amplify the influence 
of these secondary effects,
often inducing significant estimation bias.
...
In theory, 
scan optimization approach \eqref{eq:scn-dsgn,P-star} 
...
may be attributable 
to differences in signal model sensitivities 
