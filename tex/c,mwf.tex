...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{An Fast Acquisition for Precise MWF Estimation}
\label{s,mwf,acq}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for precise MWF estimation.
Subsection~\ref{ss,mwf,acq,bayes} 
...
in Chapter~\ref{c,scn-dsgn}) accordingly.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{SPGR/DESS Acquisition Design using the Bayesian CRB}
\label{ss,mwf,acq,bayes}

% first start re-deriving
% when you get to min-max step, stop to motivate
% min-max non-differentiable in P (as mentioned in prev discussion)
% P expected to be higher dimensional than app in ch 4
% thus more convenient to build a cost amenable to gradient-based local opt

adapts our method for QMRI scan design
as discussed in Chapter~\ref{c,scn-dsgn}
to be amenable 
