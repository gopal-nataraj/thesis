...
% comparison studies
% validate with mese implementation
% jfn already implemented mese

% exploring model mismatch 
% exchange, three-pool, fixed t1
% scan opt needs to be diff; but maybe design with simpler model?

% comparison with mt
% different measure of myelination - does it correlate?

% clinical collaboration (long-term?)
