...
% evidence of perk scalability

% omit comparison to mc-despot since may not be statistically meaningful

% mese can also be sped up by grase, but here we focus on accuracy

% exchange

% more compartments
% exploit comp off-res
