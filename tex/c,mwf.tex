...
of the compartmental transverse magnetization
...
Since (with proper selection) dephasing gradients
...
dephasing gradients contribute primarily 
to off-resonance phase accrual 

Since dephasing gradients 
of appropriately small area
contribute primarily
to off-resonance phase accrual 
as to impart negligible self-diffusion with each compartment
and negligible inter-diffusion between compartments,

For sufficiently small dephasing gradient moments,
we can neglect 

% self-diffusion stronger than inter-diffusion
