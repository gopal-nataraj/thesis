...
\subsubsection{Choosing Regularization Parameters $\rho_1,\dots,\rho_L$}
...
to be distributed as $\gauss{\zeros{L}}{N\diag{\rho_1,\dots,\rho_L}}$,
...
with respect to 
training point sampling distributions.

\subsubsection{Choosing Smoothing Length Scale $\bmL$}
\label{sss,krr,pract,mod,lam}



\subsubsection{Choosing Kernel Approximation Order $Z$}
