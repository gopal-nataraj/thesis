...
Table~\ref{tab,sim} compares sample statistics
of VPM, PGPM, and PERK $\mzero,\To,\Tt$ estimates,
...
\begin{figure}[!t]
	...
	\begin{minipage}{\textwidth}
  	\subfigure{%
  		...
  		\label{fig,hpd-tight,m0,im-gray}
  	}
  	\hspace{0cm}
  	\subfigure{%
...
Fig.~\ref{fig,hpd-tight,plot} compares
...
and demonstrated in \edit{Subsection~\ref{ss,phant,broad}},
...
Table~\ref{tab,brain} summarizes sample statistics
of VPM, PGPM, and PERK $\To,\Tt$ estimates,
...
\begin{figure*}[!t]
	...
	\caption{%
		...
		and NIST NMR reference measurements \cite{keenan:16:msm}.
		Unlike analogous results in Fig.~\ref{fig,hpd-tight,plot},
...
\begin{figure}[!t]
	...
	\begin{minipage}{\textwidth}
  	\subfigure{%
  		...
  		\label{fig,hpd-broad,m0,im-gray}
  	}
  	\hspace{0cm}
  	\subfigure{%
  		\includegraphics [width=0.982\textwidth,trim=0 0 0 25,clip] {%
...
via $L$ evaluations of \eqref{eq,xl-apx}
can be implemented 
...
to the case of Gaussian kernel \eqref{eq,kern}
