...
\newcommand{\logunif}[1]{\operatorname{logunif}\paren{#1}}
\newcommand{\GP}[2]{\mathcal{GP}\paren{#1,#2}}
\newcommand{\supp}[1]{\mathsf{supp}\paren{#1}}
...
\newcommand{\med}[1]{\operatorname{med}\paren{#1}}

% bias and covariance
\newcommand{\bias}{\operatorname{bias}}
\newcommand{\biasv}{\operatorname{\mathbf{b}}}
\newcommand{\biasa}[1]{\bias\paren{#1}}
\newcommand{\biasva}[1]{\biasv\paren{#1}}
\newcommand{\cov}{\operatorname{cov}}
\newcommand{\cova}[1]{\cov\paren{#1}}
...
% complexity
\newcommand{\BigOh}[1]{O\paren{#1}}
\newcommand{\BigOm}[1]{\Omega\paren{#1}}
\newcommand{\BigTh}[1]{\Theta\paren{#1}}
